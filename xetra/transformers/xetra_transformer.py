...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: foo.S3BucketConnector,
                 s3_bucket_trg: foo.S3BucketConnector, meta_key: str,
        ...
        self.extract_date, self.extract_date_list = foo3.MetaProcess.return_date_list(
    ...
    def load(self, data_frame: pd.DataFrame):
        ...
        # Updating meta file
        foo3.MetaProcess.update_meta_file(self.meta_update_list, self.meta_key, self.s3_bucket_trg)
