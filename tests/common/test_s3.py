"""
Create a framework for unit tetsting
...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def setUp(self):
        """
        execute it before starting to execute the actual test
        ...
        self.s3_endpoint_url = 'https://s3.eu-central-1.amazonaws.com' # https://us-east-1.console.aws.amazon.com
        ...
        self.s3.create_bucket(Bucket=self.s3_bucket_name,
                                  CreateBucketConfiguration={
                                      'LocationConstraint': 'eu-central-1'}) #'us-east-1'
        self.s3_bucket = self.s3.Bucket(self.s3_bucket_name)
        # Creating a testing instance
        self.s3_bucket_conn = foo.S3BucketConnector(self.s3_access_key,
                                                self.s3_secret_key,
