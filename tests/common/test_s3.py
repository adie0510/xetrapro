...
spec3 = importlib.util.spec_from_file_location("custom_exceptions", "/Users/adarsh/xetraPro/xetrapro/xetra/common/custom_exceptions.py")
...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_write_df_to_s3_wrong_format(self):
        ...
        exception_exp = foo3.WrongFormatException
        # Method execution
        with self.assertLogs() as logm:
